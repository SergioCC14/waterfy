...
set :linked_files, %w{config/database.yml config/mongoid.yml config/secrets.yml .env}

set(:config_files, %w(config/database.yml config/mongoid.yml config/secrets.yml .env))
